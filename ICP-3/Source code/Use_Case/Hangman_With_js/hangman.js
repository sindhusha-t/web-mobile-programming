...
var Hangman = (function () {
    ...
    function Hangman(elId) {
        ...
        this.hints      = {'PROGRAMMER': ['techie', 'hacker', 'engineer'], 'BRAINSTORM': ['analyse'], 'CREATIVE': ['intelligent'], 'LOLLIPOP': ['icecream'], 'CULTURE': ['lifestyle'], 'RAZORSHARP': ['sharp'], 'SCREWDRIVER': ['handtool'], 'TYPEWRITER': ['typer']};
        this.hintimages = {'PROGRAMMER':'./programmer.jpeg', 'BRAINSTORM':'./brainstorm.jpg', 'CREATIVE':'./creative.jpg', 'LOLLIPOP':'./lollipop.png', 'CULTURE':'./culture.jpg', 'RAZORSHARP':'./razorsharp.jpg', 'SCREWDRIVER':'./screwdriver.png', 'TYPEWRITER':'./typewriter.png'};
    }
